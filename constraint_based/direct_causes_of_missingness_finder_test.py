...
from .direct_causes_of_missingness_finder import AddDirectCausesOfMissingnessToGraph
...
def test_2_multinom_RVs_MCAR(
    ...
    direct_causes_of_missingness_finder = AddDirectCausesOfMissingnessToGraph(
        data=df_with_mi,
